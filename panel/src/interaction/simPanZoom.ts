...
export function centerZoomSimulation(scale: number) {
...
export function zoomSimulationAtPoint(pt: { x: number; y: number }, simScale: number) {
...
export function simPan(e: PointerEvent) {
...
export function simZoom(e: WheelEvent) {
  let simScale: number;
