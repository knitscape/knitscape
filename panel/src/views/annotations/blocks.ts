...
function draggers(blockIndex: number) {
  return html`<button
      class="move-block"
      @pointerdown=${(e: PointerEvent) => moveBlock(e, blockIndex)}>
      <i class="fa-solid fa-arrows-up-down-left-right"></i>
    </button>
    <button
      class="dragger up"
      @pointerdown=${(e: PointerEvent) => resizeBlock(e, blockIndex, "up")}>
      <i class="fa-solid fa-angle-up"></i>
    </button>
    <button
      class="dragger down"
      @pointerdown=${(e: PointerEvent) => resizeBlock(e, blockIndex, "down")}>
      <i class="fa-solid fa-angle-down"></i>
    </button>
    <button
      class="dragger left"
      @pointerdown=${(e: PointerEvent) => resizeBlock(e, blockIndex, "left")}>
      <i class="fa-solid fa-angle-left"></i>
    </button>
    <button
      class="dragger right"
      @pointerdown=${(e: PointerEvent) => resizeBlock(e, blockIndex, "right")}>
