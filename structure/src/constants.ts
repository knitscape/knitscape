import type { SymbolName, ToolData, PatternLibrary } from "./types";
...
export const SYMBOL_BITS: Record<SymbolName, boolean> = {
  knit: false,
  purl: false,
  slip: true,
  tuck: true,
...
export const DEFAULT_SYMBOLS: SymbolName[] = ["knit", "purl", "slip", "tuck"];

export const DEFAULT_PATTERN_LIBRARY: PatternLibrary =
  import.meta.glob("../examples/*.json") as PatternLibrary;
